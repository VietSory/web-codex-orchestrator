...
6. Concurrency stays bounded/backpressured. Retryable transport/rate-limit failures use typed backoff; policy/authority failures are not hot-retried.
...
- I/O: content-addressed repository/project-map reuse and deterministic evidence avoid repeated full-repository/context assembly where the contract permits reuse.
