...
import { assertReadyForPublish, assertSolCanStart } from "../src/execution/review-gates.js";
...
function review(digest: string): ReviewResult { return { verdict: "APPROVE", reviewed_change_set_sha256: digest, summary: "ok", acceptance_results: [], blocking_findings: [], non_blocking_findings: [], scope_violations: [], unverified_acceptance: [], recommended_next_state: "SOL_REVIEWING", human_action: null }; }
