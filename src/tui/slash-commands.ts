export const SLASH_COMMANDS = [
  ...
  ["/web status", "Show official Web-native connection and pending work"],
  ["/web connect", "One-time official OpenAI/ChatGPT Web-native setup"],
  ["/web open", "Open official ChatGPT app/developer settings"],
  ["/web disconnect", "Remove the locally stored Web-native credential"],
  ...
  ["/config web", "Configure/reconnect the default Web-native transport"],
