export const SLASH_COMMANDS = [
  ...
  ["/web status", "Show managed Web authorization and pending work"],
  ["/web connect", "One-time one-link WCO Web authorization"],
  ["/web open", "Show Web automation status (no per-task browser step)"],
  ["/web disconnect", "Revoke/remove the locally stored WCO Web authorization"],
  ...
  ["/config web", "Authorize/reconnect the default managed Web transport"],
