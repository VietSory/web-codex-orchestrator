// Result Bundle contracts for Phase 6 — deterministic output handoff
// All error codes match FAILURE-MATRIX.md exactly.
...
export type ResultBundleErrorCode =
  ...
  | "RESULT_STATE_DIR_UNSAFE"
  | "RESULT_EXECUTION_NOT_READY"
  | "RESULT_EXECUTION_RECEIPT_INVALID"
  | "RESULT_EXECUTION_RECEIPT_INCONSISTENT"
  | "RESULT_BUNDLE_MUTATED"
  | "RESULT_CHANGE_SET_STALE"
  | "RESULT_PUBLISH_NOT_PUSHED"
  | "RESULT_PUBLISH_RECEIPT_INVALID"
  | "RESULT_PUBLISH_RECEIPT_INCONSISTENT"
  | "RESULT_REMOTE_SHA_MISMATCH"
  | "RESULT_PR_NOT_OPEN"
  | "RESULT_PR_RECEIPT_INVALID"
  | "RESULT_PR_RECEIPT_INCONSISTENT"
  | "RESULT_PR_AUTH_UNAVAILABLE"
  | "RESULT_PR_API_UNAUTHORIZED"
  | "RESULT_PR_API_FORBIDDEN"
  | "RESULT_PR_API_NOT_FOUND"
  | "RESULT_PR_API_RATE_LIMITED"
  | "RESULT_PR_API_REDIRECT_REJECTED"
  | "RESULT_PR_API_RESPONSE_TOO_LARGE"
  | "RESULT_PR_API_RESPONSE_INVALID"
  | "RESULT_PR_API_FAILED"
  | "RESULT_PR_IDENTITY_MISMATCH"
  | "RESULT_PR_MERGED"
  | "RESULT_GIT_INSPECTION_FAILED"
  | "RESULT_DIFF_MISMATCH"
  | "RESULT_UNSUPPORTED_CHANGE_TYPE"
  | "RESULT_SOURCE_PATH_UNSAFE"
  | "RESULT_SOURCE_CONTENT_MISMATCH"
  | "RESULT_SOURCE_FILE_TOO_LARGE"
  | "RESULT_SENSITIVE_VALUE_DETECTED"
  | "RESULT_ARCHIVE_ENTRY_LIMIT"
  | "RESULT_ARCHIVE_SIZE_LIMIT"
  | "RESULT_ARCHIVE_PATH_COLLISION"
  | "RESULT_ARCHIVE_BUILD_FAILED"
  | "RESULT_ARCHIVE_VERIFY_FAILED"
  | "RESULT_OUTPUT_CONFLICT"
  | "RESULT_RECEIPT_INVALID"
  | "RESULT_RECEIPT_INCONSISTENT"
  | "RESULT_LOCKED"
  | "RESULT_STALE_LOCK"
  | "RESULT_INTERRUPTED"
...
export class ResultBundleError extends Error {
  ...
  constructor(code: ResultBundleErrorCode, message: string) {
    super(message);
...
export function isResultBundleError(error: unknown): error is ResultBundleError {
  return error instanceof ResultBundleError;
}

/** Exit code per FAILURE-MATRIX.md */
...
/** Public pull request attestation snapshot */
...
/** Public git publish evidence DTO */
...
/** Changed file entry for repository/changed-files.json */
...
/** Deleted file entry for repository/deleted-files.json */
export interface DeletedFileEntry {
  path: string;
}

/** Result bundle limits from config */
