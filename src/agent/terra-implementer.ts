...
export async function assessWithTerra(client: AgentClient, request: { model: string; reasoning_effort: "minimal" | "low" | "medium" | "high" | "xhigh"; prompt: string; threadId: string | undefined; workspacePath: string; acceptedBundlePath: string; signal?: AbortSignal | undefined }): Promise<{ response: AgentTurnResponse; assessment: AgentAssessment }> {
...
export async function implementWithTerra(client: AgentClient, request: { model: string; reasoning_effort: "minimal" | "low" | "medium" | "high" | "xhigh"; prompt: string; threadId: string; workspacePath: string; acceptedBundlePath: string; signal?: AbortSignal | undefined }): Promise<{ response: AgentTurnResponse; implementation: AgentImplementationResult }> {
