...
export interface RelayAuthenticator { authenticate(header: string | undefined): RelayPrincipal; }

export class PersonalBearerAuthenticator implements RelayAuthenticator {
