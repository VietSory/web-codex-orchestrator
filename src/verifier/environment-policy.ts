...
const DENIED = [
  /^PATH$/i, /^HOME$/i, /^USERPROFILE$/i, /^SYSTEMROOT$/i, /^SHELL$/i, /^COMSPEC$/i,
  /^CODEX_HOME$/i, /^BASH_ENV$/i, /^ENV$/i, /^CDPATH$/i, /^IFS$/i,
  /^NODE_OPTIONS$/i, /^PYTHONPATH$/i, /^LD_PRELOAD$/i, /^DYLD_/i,
  /^GIT_CONFIG/i, /^GIT_DIR$/i, /^GIT_WORK_TREE$/i, /^SSH_/i,
  /^AWS_/i, /^AZURE_/i, /^GOOGLE_/i, /^GITHUB_/i, /^OPENAI_/i,
  /^NPM_CONFIG_/i, /^COREPACK_/i, /TOKEN/i, /SECRET/i, /PASSWORD/i,
  /CREDENTIAL/i, /AUTH/i, /PROXY/i,
];
