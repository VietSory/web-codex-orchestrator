...
The retained managed profile may still be useful for an explicitly selected future multi-user/SaaS deployment. It must never become a silent fallback when the local transport is unavailable.
